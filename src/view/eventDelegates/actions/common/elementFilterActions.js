...
const SET_SHOW_SPECIFIC_ELEMENTS_FILTER = 'eventDelegates/elementFilter/SET_SHOW_SPECIFIC_ELEMENTS_FILTER';
const SET_SHOW_ELEMENT_PROPERTIES_FILTER = 'eventDelegates/elementFilter/SET_SHOW_ELEMENT_PROPERTIES_FILTER';
const SET_ELEMENT_SELECTOR = 'eventDelegates/elementFilter/SET_ELEMENT_SELECTOR';
const ADD_ELEMENT_PROPERTY = 'eventDelegates/elementFilter/ADD_ELEMENT_PROPERTY';
const REMOVE_ELEMENT_PROPERTY = 'eventDelegates/elementFilter/REMOVE_ELEMENT_PROPERTY';
const EDIT_ELEMENT_PROPERTY = 'eventDelegates/elementFilter/EDIT_ELEMENT_PROPERTY';
