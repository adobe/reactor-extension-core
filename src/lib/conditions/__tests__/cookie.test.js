...
describe('cookie condition delegate', function () {
  ...
  it('returns false if the cookie "value" list is empty', function () {
    var settings = { name: 'test', value: [] };
    expect(conditionDelegate(settings)).toBe(false);
  });
    ...
    describe('as strings', function () {
      describe('returns false when', function () {
        it('the list is of size 1', function () {
          var settings = { name: 'test', value: [{ value: 'bizbaz' }] };
          expect(conditionDelegate(settings)).toBe(false);
        });
        ...
        it('the list has many items', function () {
          var settings = {
            name: 'test',
            value: [{ value: 'bizzy' }, { value: 'bazzy' }, { value: 'buzzy' }]
          };
          expect(conditionDelegate(settings)).toBe(false);
        });
      });
      ...
      describe('returns true when', function () {
        it('the list is of size 1', function () {
          var settings = { name: 'test', value: [{ value: 'foo' }] };
          expect(conditionDelegate(settings)).toBe(true);
        });
        ...
        it('the match is at the front of a many item list', function () {
          var settings = {
            name: 'test',
            value: [{ value: 'foo' }, { value: 'bazzy' }, { value: 'buzzy' }]
          };
          expect(conditionDelegate(settings)).toBe(true);
        });
        ...
        it('the match is in the middle of a many item list', function () {
          var settings = {
            name: 'test',
            value: [{ value: 'bizzy' }, { value: 'foo' }, { value: 'buzzy' }]
          };
          expect(conditionDelegate(settings)).toBe(true);
        });
        ...
        it('the match is at the end of a many item list', function () {
          var settings = {
            name: 'test',
            value: [{ value: 'bizzy' }, { value: 'bazzy' }, { value: 'foo' }]
          };
          expect(conditionDelegate(settings)).toBe(true);
        });
      });
    ...
    describe('as RegularExpressions', function () {
      describe('returns false when', function () {
        it('the list is of size 1', function () {
          var settings = {
            name: 'test',
            value: [{ value: 'g.o', valueIsRegex: true }]
          };
          expect(conditionDelegate(settings)).toBe(false);
        });
      ...
      describe('returns true when', function () {
        it('the list is of size 1', function () {
          var settings = {
            name: 'test',
            value: [{ value: 'F.o', valueIsRegex: true }]
          };
          expect(conditionDelegate(settings)).toBe(true);
        });
