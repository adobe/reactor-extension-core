...
// ESM does not support inject-loader. Consider using a compatible mocking strategy.
describe('query string parameter condition delegate (inject-loader)', function () {
