 ...
 * @param {Object[]} settings.value Acceptable JS variable values to match.
 * @param {string} settings.value[].value An acceptable JS variable value.
 * @param {string} [settings.value[].valueIsRegex=false] Is the JS variable
