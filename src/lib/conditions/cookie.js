 ...
 * @param {Object[]} settings.value Acceptable cookie values to match.
 * @param {string} settings.value[].value An acceptable cookie value.
 * @param {string} [settings.value[].valueIsRegex=false] Is the cookie
