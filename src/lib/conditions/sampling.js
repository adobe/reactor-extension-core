...
function injectSampling({ getNamespacedStorage }) {
   ...
   * @returns {boolean}
   */
  return function sampling(settings, event) {
...
const validateInjection = validateInjectedParams(injectSampling);
...
/* START.TESTS_ONLY */
export { validateInjection as injectSampling };
/* END.TESTS_ONLY */
