...
function injectChange({ document }) {
   ...
   */
  return function change(settings, trigger) {
    const acceptableChangeValues = Array.isArray(
...
const validateInjection = validateInjectedParams(injectChange);
...
/* START.TESTS_ONLY */
export { validateInjection as injectChange };
/* END.TESTS_ONLY */
