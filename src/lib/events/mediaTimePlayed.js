...
function injectMediaTimePlayed({ document }) {
   ...
   */
  return function mediaTimePlayed(settings, trigger) {
...
const validateInjection = validateInjectedParams(injectMediaTimePlayed);
...
/* START.TESTS_ONLY */
export { validateInjection as injectMediaTimePlayed };
/* END.TESTS_ONLY */
