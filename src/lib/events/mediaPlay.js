...
function injectMediaPlay({ document }) {
   ...
   */
  return function mediaPlay(settings, trigger) {
    bubbly.addListener(settings, trigger);
  };
}

const validateInjection = validateInjectedParams(injectMediaPlay);
...
/* START.TESTS_ONLY */
export { validateInjection as injectMediaPlay };
/* END.TESTS_ONLY */
