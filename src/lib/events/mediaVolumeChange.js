...
function injectMediaVolumeChange({ document }) {
   ...
   */
  return function mediaVolumeChangeEvent(settings, trigger) {
    bubbly.addListener(settings, trigger);
  };
}

const validateInjection = validateInjectedParams(injectMediaVolumeChange);
...
/* START.TESTS_ONLY */
export { validateInjection as injectMediaVolumeChange };
/* END.TESTS_ONLY */
